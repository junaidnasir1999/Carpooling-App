...
const DropoffLocationPicker = ({navigation, route}) => {
  const {pickupCoords, pickupLocation, myLocation, startTime, endTime, hourBlock} =
    route.params;
  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
      <GeneralHeader
        heading={'Choose Dropoff Location'}
...
export default DropoffLocationPicker;
